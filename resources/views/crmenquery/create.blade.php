            ...
            <div class="col-lg-7 mx-auto">
                <div class="card mt-2 mx-auto p-4 bg-light">
                    <div class="card-body bg-light">
                        ...
                        <div class = "container">
                            <form id="clientAdd" class="forms-sample" action="{{ route('crmenquery.store') }}"
                                method="POST">
                                @csrf
                                <div class="controls">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="form_lastname" type="text" name="email"
                                                    ...
                                                    placeholder="Enter Client Email" required="required"
                                                    value="{{ old('email') }}">
                                                @error('email')
                                                    <p>{{ $message }}</p>
                                                @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="form_email" type="number" name="number"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="form_message" name="message"
                                                    class="form-control @error('message') is-validate @enderror"
...
{{-- <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body pb-0">
                <form id="clientAdd" class="forms-sample" action="{{route('crmenquery.store')}}" method="POST">
                    @csrf
                    @include('crmenquery.common.form')
                </form>
            </div>
        </div>
