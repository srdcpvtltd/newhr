<div class="row">
    ...
    <div class="col-lg-4 col-md-6 mb-4">
        ...
        <select class="form-select" id="billing_name" name="billing_name">
    ...
    <div class="col-lg-4 col-md-6 mb-4">
        ...
        <input type="text" class="form-control" id="mail" name="email" required autocomplete="off" placeholder="Number">
    </div>
    <div class="col-lg-4 col-md-6 mb-4">
        <label for="pnumber" class="form-label">Request Number <span style="color: red">*</span></label>
        <input type="text" class="form-control" id="procurement_number" name="pnumber" required autocomplete="off" placeholder="Number">
    </div>
    ...
    <div class="col-lg-4 col-md-6 mb-4">
        ...
        <input type="number" class="form-control" id="procurement_number" name="quantity" required autocomplete="off" placeholder="Enter Amount">
    </div>

    <div class="col-lg-4 col-md-6 mb-4">
        <label for="amount" class="form-label">Amount<span style="color: red">*</span></label>
        <input type="number" class="form-control" id="procurement_number" name="amount" required autocomplete="off" placeholder="Enter Amount">
    </div>
